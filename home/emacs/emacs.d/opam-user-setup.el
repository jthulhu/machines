...
;; ## added by OPAM user-setup for emacs / tuareg ## 7f3d71bd9ab8b6232220b508572bd9e0 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/adri/.opam/default/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
